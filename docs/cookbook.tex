...
=======
\date{2021-09-09}
>>>>>>> 7df02c2b16394b7a4a1e821a6ca4c20e19593b92
...
\includegraphics{/home/common/users/cfairfield/cookbook/img/surgical_informatics_minibanner.png}
...
\begin{figure}
\centering
\includegraphics{img/zotero_add_on_install.png}
\caption{\label{fig:add-on-install}Installing a Zotero Plug-in from an .xpi File}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{img/zotfile_preferences.png}
\caption{\label{fig:zotfile-preferences}ZotFile PDF Storage Preferences}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{img/zotfile_renaming.png}
\caption{\label{fig:zotfile-renaming}ZotFile PDF Storage Preferences}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{img/zotero_citation_key.png}
\caption{\label{fig:zotfile-citation-key}ZotFile PDF Storage Preferences}
\end{figure}
